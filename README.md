...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tqbvz1c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tqbvz1c.containers.anotherwebservice.com/
...
```
git clone git@github.com:pknw1/container-tqbvz1c.git
cd container-tqbvz1c
```
...
```
docker attach container-tqbvz1c
```
